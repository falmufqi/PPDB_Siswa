...
$pkh=$_POST["pkh"];
  ...
  if ($hasil) {
	echo "<script>alert('Anda Berhasil Input Data Siswa');document.location='home_siswa.php'</script>";
}else{
	echo "<script>alert('Anda Gagal Menginput Data');document.location='home_siswa.php?page=input_siswa_reguler'</script>";
}
