...
<tr bgcolor="#DCDCDC">
	...
	<td>&nbsp;</td>
	<td align="center">Selamat Datang&nbsp;<font color="#FF6600"><strong> <?=$_SESSION['username_siswa']?></strong></font>&nbsp;|&nbsp;<a href="logout_siswa.php">LogOut >>&nbsp;&nbsp;</a></td>
	<td>&nbsp;</td>
</tr>
<tr bgcolor="#DCDCDC">
	<td>&nbsp;</td>
	<td rowspan="4" valign="top"><table width="144" height="2360" bgcolor="#2F4F4F" border="0" cellspacing="0" cellpadding="0" align="top">
		...
		<td valign="top"><ul class="navbar">
			<li><a href="home_siswa.php"><b>MAIN MENU</b></a></li><br>
			<li><a href="home_siswa.php?page=input_siswa_reguler" title="input-siswa-reguler">&nbsp;Input Siswa Reguler</a></li>
			<li><a href="home_siswa.php?page=input_siswa_beasiswa" title="input-siswa-beasiswa">&nbsp;Input Siswa Beasiswa</a></li>
		</ul></td>
		</tr></table></td>
	<td rowspan="4">&nbsp;</td>
	<td rowspan="4" valign="top"><table width="1136" height="2360" bgcolor="white" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			switch ($page) {
				case 'home' : include "home_siswa.php"; break;
				case 'input_siswa_reguler' : include "input_siswa_reguler_siswa.php"; break;
				case 'input_siswa_beasiswa' : include "input_siswa_beasiswa_siswa.php"; break;
				case 'main' :
				include 'petunjuk_siswa.php';
				include 'aboutuser_siswa.php';	
